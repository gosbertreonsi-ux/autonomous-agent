...
export type StorageHash =
  StorageHashBase<'49195eb9fa575bd7e85f92d5cef55d3f89762bdac814cb17d6c467e6ccc21596'>;
export type ExecutionHash =
  ExecutionHashBase<'e5e731c0a8a55aaa36611c47f7a087a04abd194eaf33d329fffa6990322d2336'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly AgentLog: {
      ...
      readonly rawInputText: CodecTypes['pg/text@1']['output'];
      readonly taskName: CodecTypes['pg/text@1']['output'];
      readonly priority: CodecTypes['pg/text@1']['output'];
      readonly estimatedHours: CodecTypes['pg/int4@1']['output'];
      readonly generatedFile: CodecTypes['pg/text@1']['output'];
    };
    readonly Post: {
...
export type FieldInputTypes = {
  readonly public: {
    readonly AgentLog: {
      ...
      readonly rawInputText: CodecTypes['pg/text@1']['input'];
      readonly taskName: CodecTypes['pg/text@1']['input'];
      readonly priority: CodecTypes['pg/text@1']['input'];
      readonly estimatedHours: CodecTypes['pg/int4@1']['input'];
      readonly generatedFile: CodecTypes['pg/text@1']['input'];
    };
    readonly Post: {
...
export namespace Models {
  ...
  export type public_AgentLog = {
    id: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    rawInputText: CodecTypes['pg/text@1']['output'];
    taskName: CodecTypes['pg/text@1']['output'];
    priority: CodecTypes['pg/text@1']['output'];
    estimatedHours: CodecTypes['pg/int4@1']['output'];
    generatedFile: CodecTypes['pg/text@1']['output'];
...
export declare const models: {
  public: {
    ...
    AgentLog: Models.public_AgentLog;
  };
};
...
> & {
  ...
  readonly roots: {
    ...
    readonly agentLog: { readonly namespace: 'public' & NamespaceId; readonly model: 'AgentLog' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly AgentLog: {
            ...
            readonly storage: {
              readonly table: 'agentLog';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly rawInputText: { readonly column: 'rawInputText' };
                readonly taskName: { readonly column: 'taskName' };
                readonly priority: { readonly column: 'priority' };
                readonly estimatedHours: { readonly column: 'estimatedHours' };
                readonly generatedFile: { readonly column: 'generatedFile' };
              };
            };
          };
          readonly Post: {
